FightFriend = CreateDialog(function ()
    ...
    if gender == true then
        ...
        Talk("나","(그거에 어이없었던 우리 애가 뭐랄까... 좀 나쁜 말을 했더니...)","None")
        Talk("나","(동급생 친구가 그걸 듣고 엉엉 울었다고...?)","None")
        Talk(name,"그렇게 살다가는 사회 낙오자 된다고밖에 애기 안했어요","shshuM_8")
        local selection = MakeSelect("나","...", "shshuM_8", {"아무리 그래도 친구한테 너무 심했다", "잘했다 애가 싸가지가 없네", "네가 잘못했다"})
        if selection==0 then
            Talk("나","그런 일이 있으면 어른한테 중재를 요청한다던가 그냥 무시하는게 나아","shshuM_8")
            Talk("나","앞으로 자주 볼 사이기도 하고 그렇게 말해서 너한테 좋을게 없어 ","shshuM_8")
            Talk("나","그냥 똑같이 나쁜 사람 되는거야","shshuM_8")
            Talk(name,"하지만 저는 나쁜짓 안했는데요?!","shshuM_8")
            Talk(name,"그냥 사실을 말한 것 뿐이잖아요!","shshuM_8")
            Talk("동급생의 부모","지금 얘가 뭐라 말하는..!!","None")
            Talk("동급생","으아아아아아아앙!!!!!!!","None")
            Talk("나","죄송합니다!","None")
            Talk(name,"......","shshuM_8")
            Talk("나","사과 하자 응?","shshuM_8")
            Talk(name,"......미안.....","shshuM_8")
            Talk("동급생","흥 됐거든","None")
            Talk("동급생의 부모","댁네 애 교육좀 잘 시키세요 이게 뭐하는짓이야 지금","None")
            local selection2 = MakeSelect("나","...", "None", {"죄송합니다", "저기요", "뭐요?"})
                if selection2==0 then
        ...
        elseif selection==2 then
            Talk(name,"저는 잘못한게 없는데..!","shushuF_8")
            Talk("나","친구한테 사과해","None")
            Talk(name,"뭘 사과해요 잘못한게 없는데!","shshuM_8")
            Talk("나","빨리","None")
            Talk(name,"....","shshuM_8")
            Talk(name,"미안","shshuM_8")
            Talk("동급생","흥 됐거든","None")
